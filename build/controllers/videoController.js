      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 8:
            ...
            res.redirect(_routes["default"].home); // 존재하지 않는 rul로 가면 home로 redirection
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 12:
            ...
            res.redirect(_routes["default"].home); // 존재하지 않는 video면 home로 redirection
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            res.redirect(_routes["default"].videoDetail(id)); // title과 description 업데이트 후 변한걸 확인하기 위해서 videoDetail로 redirection
...
var postAddComment = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(req, res) {
    var id, comment, user, video, findUser, newComment;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 10:
            ...
            video.comments.push(newComment.id); // video에있는 comments에 newComment의 id를 넣어줌
...
var postDeleteComment = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(req, res) {
    var commentId, user, comment;
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            commentId = req.body.commentId, user = req.user;
            _context10.prev = 1;
          ...
          case 5:
            ...
            // console.log(video);
            console.log(comment.id); // await video.comments.remove(comment.id);
            // await video.save();
